...
import Foundation
struct CPNMoQTourDetail: CPResponseObjectSerializable, CPResponseCollectionSerializable {
...
struct NMoQTourDetailList: CPResponseObjectSerializable {
    var nmoqTourDetailList: [CPNMoQTourDetail]? = []
    
    public init?(response: HTTPURLResponse, representation: AnyObject) {
        if let data = representation as? [[String: Any]] {
            self.nmoqTourDetailList = CPNMoQTourDetail.collection(response: response, representation: data as AnyObject)
        }
    }
}
