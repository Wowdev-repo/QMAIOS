...
class CPCommonDetailCell: UITableViewCell {
...
//                                                      comment: "MAP_REDIRECTION_MESSAGE in the Dining detail")
        ...
        if (heritageDetail.latitude != nil && heritageDetail.latitude != "" && heritageDetail.longitude != nil && heritageDetail.longitude != "") {
            self.setLocationMap(latitudeString: heritageDetail.latitude!,
                                longitudeString: heritageDetail.longitude!,
                                mapTitle: heritageDetail.name ?? "")
...
//        locationButton.setTitle(mapRedirectionMessage, for: .normal)
        ...
        if (publicArsDetail.latitude != nil && publicArsDetail.latitude != "" && publicArsDetail.longitude != nil && publicArsDetail.longitude != "") {
            self.setLocationMap(latitudeString: publicArsDetail.latitude!,
                                longitudeString: publicArsDetail.longitude!,
                                mapTitle: publicArsDetail.name ?? "")
...
extension CPCommonDetailCell {
    func setLocationMap(latitudeString: String,longitudeString: String, mapTitle: String) {
