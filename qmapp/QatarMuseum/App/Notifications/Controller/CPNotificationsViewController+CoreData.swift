//
//  CPNotificationsViewController+CoreData.swift
//  QatarMuseums
//
        ...
        if (notificationArray.count > 0) {
            ...
            if #available(iOS 10.0, *) {
                ...
                container.performBackgroundTask() {(managedContext) in
                    CPDataManager.updateNotifications(managedContext: managedContext,
        ...
        do {
            ...
            if (listArray.count > 0) {
                for entity in listArray {
                    self.notificationArray.append(CPNotification(title: entity.title,
