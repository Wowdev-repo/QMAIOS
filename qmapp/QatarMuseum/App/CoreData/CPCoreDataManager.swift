...
class CPCoreDataManager {
    
    let migrator: CPCoreDataMigrator
    
    // MARK: - Singleton
    
    static let shared = CPCoreDataManager()
    
    // MARK: - Init
    
    init(migrator: CPCoreDataMigrator = CPCoreDataMigrator()) {
    ...
    func saveContext () {
        ...
        if #available(iOS 10.0, *) {
            let context = CPCoreDataManager.shared.backgroundContext
