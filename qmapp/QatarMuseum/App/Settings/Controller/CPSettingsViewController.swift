...
//  QatarMuseums
//
//  Created by Wakralab Software Labs on 23/07/18.
...
extension CPSettingsViewController: CPHeaderViewProtocol,CPEventPopUpProtocol {
    ...
    func addToCalendarButtonPressed() {
        if ((CPLocalizationLanguage.currentAppleLanguage()) == "en") {
            CPLocalizationLanguage.setAppleLAnguageTo(lang: "ar")
            languageKey = 2
            ...
            CPLocalizationLanguage.setAppleLAnguageTo(lang: "en")
            languageKey = 1
