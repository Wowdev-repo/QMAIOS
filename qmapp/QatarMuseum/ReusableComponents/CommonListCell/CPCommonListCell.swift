...
class CPCommonListCell: UITableViewCell {
...
//        dateLabel.text = ((exhibition.startDate?.uppercased())!).replacingOccurrences(of: "<[^>]+>", with: "", options: .regularExpression, range: nil) + " - " + ((exhibition.endDate?.uppercased())!).replacingOccurrences(of: "<[^>]+>", with: "", options: .regularExpression, range: nil)
    ...
    //NMoQ Tour
    func setTourMiddleDate(tourList: CPNMoQTourDetail?) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
    ...
    //MARK: Facilities
    func setFacilitiesDetail(FacilitiesDetailData: CPFacilitiesDetail?) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
        dateLabel.font  = UIFont.homeTitleFont
    ...
    //MARK: TourList
    func setTourListDate(tourList: CPNMoQTour?,isTour: Bool?) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
    ...
    //MARK: ActivityList
    func setActivityListDate(activityList: CPNMoQActivitiesList?) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
        titleLabel.font = UIFont.homeTitleFont
    ...
    //MARK: TravelList
    func setTravelListData(travelListData: CPHomeBanner) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
        dateLabel.font = UIFont.homeTitleFont
    ...
    func setFacilitiesListData(facilitiesListData: CPFacilities?) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
        dateLabel.font = UIFont.homeTitleFont
    ...
    func setHeritageListCellValues(heritageList: CPHeritage) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
    ...
    func setPublicArtsListCellValues(publicArtsList: CPPublicArtsList) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
    ...
    func setCollectionsCellValues(collectionList: CPCollection) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
    ...
    func setDiningListValues(diningList: CPDining) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
    ...
    func setScienceTourGuideCellData(homeCellData: CPTourGuide) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
        dateLabel.font = UIFont.homeTitleFont
    ...
    //MARK: Home
    func setHomeCellData(home: CPHome) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
    ...
    //MARK:TourGuide List
    func setTourGuideCellData(museumsListData: CPHome) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
        dateLabel.font = UIFont.homeTitleFont
