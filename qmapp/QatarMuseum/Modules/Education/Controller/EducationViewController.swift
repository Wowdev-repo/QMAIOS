...
//  QatarMuseums
//
//  Created by Wakralab Software Labs on 20/07/18.
...
//FIXME:- Couldnot find any delegates
extension EducationViewController: AVPlayerViewControllerDelegate {
    
}

//MARK:- header delegate
extension EducationViewController: HeaderViewProtocol {
