//
//  CPPanelDiscussionDetailViewController+Tableview.swift
//  QatarMuseums
//
...
import Foundation
extension CPPanelDiscussionDetailViewController : UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print(indexPath)
        if let cell = tableView.dequeueReusableCell(withIdentifier: "customPanelCellIdentifier", for: indexPath) as? CPPanelDetailCell {
            ...
            if(self.pageNameString == NMoQPanelPage.PanelDetailPage) {
                ...
                if let collectionCell = tableView.dequeueReusableCell(withIdentifier: "collectionCellId", for: indexPath) as? CPCollectionDetailCell {
