//
//  CPFloorMapViewController.swift
//  QatarMuseums
//
...
class CPFloorMapViewController: UIViewController, UIGestureRecognizerDelegate {
...
//                }
       ...
       // DispatchQueue.main.async {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(CPFloorMapViewController.receiveFloormapNotification(notification:)), name: NSNotification.Name(floormapNotification), object: nil)
...
//        } else {
            let numberPadView = self.storyboard?.instantiateViewController(withIdentifier: "artifactNumberPadViewId") as! CPArtifactNumberPadViewController
            let transition = CATransition()
            transition.duration = 0.3
...
//        }
    ...
    func setupTimer(){
        ...
        timer = Timer(timeInterval: 0.001, target: self, selector: #selector(CPFloorMapViewController.tick), userInfo: nil, repeats: true)
