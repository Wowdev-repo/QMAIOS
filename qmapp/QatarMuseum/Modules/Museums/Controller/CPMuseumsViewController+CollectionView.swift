//
//  CPMuseumsViewController+CollectioView.swift
//  QatarMuseums
//
...
extension CPMuseumsViewController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let museumsCell : CPMuseumBottomCell = museumsBottomCollectionView.dequeueReusableCell(withReuseIdentifier: "museumCellId", for: indexPath) as! CPMuseumBottomCell
    ...
    func loadBottomCellPages(cellObj: CPMuseumBottomCell, selectedItem: String?) {
        ...
        if fromHomeBanner {
            ...
            if ((selectedItem == "About") || (selectedItem == "عن")) {
                ...
                let heritageDtlView = detailStoryboard.instantiateViewController(withIdentifier: "heritageDetailViewId2") as! CPMuseumAboutViewController
                ...
                let tourView =  self.storyboard?.instantiateViewController(withIdentifier: "tourAndPanelId") as! CPTourAndPanelListViewController
                tourView.pageNameString = CPNMoQPageName.Facilities
                let transition = CATransition()
                transition.duration = 0.25
                transition.type = kCATransitionPush
                transition.subtype = kCATransitionFromRight
