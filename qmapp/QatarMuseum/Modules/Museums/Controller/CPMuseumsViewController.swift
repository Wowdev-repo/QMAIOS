...
extension CPMuseumsViewController {
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier == "museumsToAboutSegue") {
            let museumAboutView = segue.destination as! CPMuseumAboutViewController
            ...
            let tourAndPanelView = segue.destination as! CPTourAndPanelListViewController
            if (selectedItemName == tourBanner) {
                tourAndPanelView.pageNameString = CPNMoQPageName.Tours
            } else if (selectedItemName == travelBanner) {
                tourAndPanelView.bannerId = bannerId
                tourAndPanelView.pageNameString = CPNMoQPageName.TravelArrangementList
            } else if (selectedItemName == panelBanner) {
                tourAndPanelView.pageNameString = CPNMoQPageName.PanelDiscussion
