//
//  CPCulturePassCardViewController.swift
//  QatarMuseums
//
//  Created by Wakralab Software Labs on 22/10/18.
...
class CPCulturePassCardViewController: UIViewController {
...
//        tapToFlipButton.layer.cornerRadius = 25
    ...
    @IBAction func didTapTapToFlip(_ sender: UIButton) {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function), line: \(#line)")
        let cardBackView =  self.storyboard?.instantiateViewController(withIdentifier: "cardBackId") as!CPCulturePassCardBackViewController
