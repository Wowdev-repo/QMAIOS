...
class CPEventViewController: UIViewController,UIViewControllerTransitioningDelegate {
...
//        return ((LocalizationLanguage.currentAppleLanguage()) == AR_LANGUAGE) ? self.showArabicSubTitle(date: date) : nil
//    }
}

extension CPEventViewController: UIGestureRecognizerDelegate {
