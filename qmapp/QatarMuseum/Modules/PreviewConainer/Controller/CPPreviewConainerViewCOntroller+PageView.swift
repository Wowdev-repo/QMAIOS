//
//  CPPreviewConainerViewCOntroller+PageView.swift
//  QatarMuseums
//
...
extension CPPreviewContainerViewController: UIPageViewControllerDelegate,UIPageViewControllerDataSource {
    //MARk: PAgeViewController delegates
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        var index: Int? = (viewController as? CPPreviewContentViewController)?.pageIndex
...
extension CPPreviewContainerViewController {
    ...
    func setUpPageControl() {
        ...
        let startingViewController: CPPreviewContentViewController = self.viewControllerAtIndex(index: 0)!
