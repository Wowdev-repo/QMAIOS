//
//  CPPreviewContainerViewController.swift
//  QatarMuseums
//
...
class CPPreviewContainerViewController: UIViewController,UIGestureRecognizerDelegate {
    ...
    var currentContentViewController: CPPreviewContentViewController!
    ...
    func filterButtonPressed() {
        ...
        if (tourGuideArray.count != 0) {
            ...
            if((selectedItem.artifactPosition != nil) && (selectedItem.artifactPosition != "") && (selectedItem.floorLevel != nil) && (selectedItem.floorLevel != "")) {
                let floorMapView =  self.storyboard?.instantiateViewController(withIdentifier: "floorMapId") as!CPFloorMapViewController
