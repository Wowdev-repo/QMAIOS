//
//  CPMuseumAboutViewController.swift
//  QatarMuseums
//
//  Created by Wakralab Software Labs on 01/10/18.
...
class CPMuseumAboutViewController: UIViewController,UIGestureRecognizerDelegate {
    ...
    var selectedCell : CPMuseumAboutCell?
    ...
    override func viewDidLoad() {
        ...
        if (pageNameString == PageName2.museumAbout) {
            if  (networkReachability?.isReachable)! {
             ...
             NotificationCenter.default.addObserver(self, selector: #selector(CPMuseumAboutViewController.receiveNmoqAboutNotification(notification:)), name: NSNotification.Name(nmoqAboutNotification), object: nil)
            self.fetchAboutDetailsFromCoredata()
//            if  (networkReachability?.isReachable)! {
