...
class CPHomeViewController: UIViewController,UIViewControllerTransitioningDelegate { //FIXME: Transition delegates couldnt be found in class
    ...
    var isSideMenuLoaded : Bool = false // FIXME: This var hasnt been used anywhere
    var homeList: [Home]! = []
...
//MARK: - table View delegates and processes
...
//MARK: - PopUp Views delegates and processes
extension CPHomeViewController: comingSoonPopUpProtocol, LoginPopUpProtocol, LoadingViewProtocol{
    
    //MARK: ComingSoon initialization
    ...
    //MARK: Loading View initialization
    func showNodata() {
...
extension CPHomeViewController: TopBarProtocol{
...
extension CPHomeViewController: SideMenuProtocol {
...
extension CPHomeViewController {
   ...
   func fetchHomeInfoFromCoredata() {
    ...
    func saveHomeBannerToCoreData(homeListDict: HomeBanner, managedObjContext: NSManagedObjectContext) {
        //        if ((LocalizationLanguage.currentAppleLanguage()) == ENG_LANGUAGE) {
        let homeInfo: HomeBannerEntity = NSEntityDescription.insertNewObject(forEntityName: "HomeBannerEntity",
        ...
        do {
            ...
            if (homeArray.count > 0) {
                for i in 0 ... homeArray.count-1 {
                    ...
                    self.homeBannerList.insert(HomeBanner(title: homeArray[i].title, fullContentID: homeArray[i].fullContentID, bannerTitle: homeArray[i].bannerTitle, bannerLink: homeArray[i].bannerLink,image: imagesArray, introductionText: nil, email: nil, contactNumber: nil, promotionalCode: nil, claimOffer: nil, language: homeArray[i].language), at: i)
...
//MARK: - Home View Segue Controller
extension CPHomeViewController {
