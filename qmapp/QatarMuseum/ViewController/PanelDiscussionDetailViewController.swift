...
//  QatarMuseums
//
//  Created by Wakralab on 01/12/18.
...
class PanelDiscussionDetailViewController: UIViewController {
...
extension PanelDiscussionDetailViewController: HeaderViewProtocol {
...
//MARK:- Popup methods
extension PanelDiscussionDetailViewController: LoadingViewProtocol,
            comingSoonPopUpProtocol,DeclinePopupProtocol,EventPopUpProtocol {
    func showNodata() {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function)")
...
extension PanelDiscussionDetailViewController: UIPickerViewDelegate,
...
//MARK:- MFMailCompose delegates
extension PanelDiscussionDetailViewController: MFMailComposeViewControllerDelegate {
...
extension PanelDiscussionDetailViewController: UIGestureRecognizerDelegate { //FIXME: Couldnt find gesture delegate functions
        ...
        if (fetchData.count > 0) {
            for i in 0 ... facilitiesDetail.count-1 {
                ...
                if(fetchResult.count != 0) {
                    ...
                    //save
                    self.saveFacilitiesDetailsToCoreData(facilitiesDetailDict: facilitiesDetailDict,
...
extension PanelDiscussionDetailViewController {
    //MARK: NMoQSpecialEvent WebService Call
