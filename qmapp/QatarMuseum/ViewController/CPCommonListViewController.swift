...
extension CPCommonListViewController: UITableViewDelegate,UITableViewDataSource {
...
extension CPCommonListViewController: UICollectionViewDelegateFlowLayout {
    //FIXME: COuldnt find any delegate functions
}

extension CPCommonListViewController: HeaderViewProtocol {
...
extension CPCommonListViewController: comingSoonPopUpProtocol,LoadingViewProtocol {
    //MARK: No data popup
    func showNodata() {
        DDLogInfo(NSStringFromClass(type(of: self)) + "Function: \(#function), line: \(#line)")
...
extension CPCommonListViewController {
    ...
    //MARK: TourGuide Coredata Method
    ...
    func fetchTourGuideListFromCoredata() {
        ...
        do {
            ...
            tourGuideArray = checkAddedToCoredata(entityName: "TourGuideEntity",
                                                  idKey: "museumsEntity",
                                                  idValue: museumId,
                                                  managedContext: managedContext) as! [TourGuideEntity]
    ...
    //MARK: Facilities Coredata Method
    ...
    func fetchFacilitiesDetailsFromCoredata() {
        ...
        do {
            ...
            facilitiesDetailArray = checkAddedToCoredata(entityName: "FacilitiesDetailEntity",
                                                         idKey: "category",
                                                         idValue: tourDetailId,
                                                         managedContext: managedContext) as! [FacilitiesDetailEntity]
    ...
    func coreDataInBackgroundThread(managedContext: NSManagedObjectContext) {
        //        if ((LocalizationLanguage.currentAppleLanguage()) == ENG_LANGUAGE) {
        let fetchData = checkAddedToCoredata(entityName: "NmoqTourDetailEntity",
                                             idKey: "nmoqEvent",
                                             idValue: tourDetailId,
        ...
        if (fetchData.count > 0) {
            for i in 0 ... nmoqTourDetail.count-1 {
                ...
                let fetchResult = checkAddedToCoredata(entityName: "NmoqTourDetailEntity",
                                                       idKey: "nid",
                                                       idValue: tourDetailDict.nid, managedContext: managedContext)
                //update
                if(fetchResult.count != 0) {
    ...
    func fetchTourDetailsFromCoredata() {
        ...
        do {
            ...
            tourDetailArray = checkAddedToCoredata(entityName: "NmoqTourDetailEntity",
                                                   idKey: "nmoqEvent",
                                                   idValue: tourDetailId,
                                                   managedContext: managedContext) as! [NmoqTourDetailEntity]
    ...
    func diningCoreDataInBackgroundThread(managedContext: NSManagedObjectContext,diningListArray : [Dining]?,lang: String?) {
        ...
        fetchData = checkAddedToCoredata(entityName: "DiningEntity",
                                         idKey: "lang",
                                         idValue: langVar,
...
extension CPCommonListViewController {
    ...
    @objc func receiveHomePageNotificationAr(notification: NSNotification) {
     ...
     //MARK: Collection list Notification Functions
    ...
    //MARK: Exhibition Notification Functions
    ...
    //MARK: MiaTour Notification Functions
    ...
    //MARK: NMoQ park Notification Functions
    ...
    //MARK: Heritage Notification Functions
    ...
    //MARK: PublicArts Notification Functions
...
extension CPCommonListViewController {
    ...
    //MARK: NMoQTour SecondList ServiceCall
    ...
    //MARK: Collection list WebService
    ...
    //MARK: Public Arts WebServiceCall
