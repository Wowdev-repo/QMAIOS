...
//  QatarMuseum
//
//  Created by Wakralab on 07/06/18.
...
class CPEventViewController: UIViewController{
...
extension CPEventViewController: UICollectionViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension CPEventViewController: FSCalendarDelegate,FSCalendarDataSource {
...
extension CPEventViewController: comingSoonPopUpProtocol,LoadingViewProtocol {
...
//MARK:- EventPopup Delegates ad methods
extension CPEventViewController: EventPopUpProtocol {
...
extension CPEventViewController: UIViewControllerTransitioningDelegate,UIGestureRecognizerDelegate  {
...
extension CPEventViewController: HeaderViewProtocol {
    ...
    @objc func filterButtonPressed() {
        let filterView =  self.storyboard?.instantiateViewController(withIdentifier: "filterVcId") as! CPFilterViewController
...
extension CPEventViewController {
